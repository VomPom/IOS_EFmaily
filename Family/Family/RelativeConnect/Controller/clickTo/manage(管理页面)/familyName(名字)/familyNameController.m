...
@interface familyNameController ()<UITextFieldDelegate>

@end

@implementation familyNameController
...
-(void)UItextview
{
    ...
    _textField.placeholder=@"请输入亲友圈名";
...
-(void)Navigation
{
    ...
    [self.navigationItem setTitle:@"亲友圈名称修改"];
